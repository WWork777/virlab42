...
import slide6 from "./brk42.jpg";
import slide4 from "./iluma.jpg";
import slide1 from "./iluma-store.ru.png";
import slide3 from "./yurist42.jpg";
import slide7 from "./tipmestudio.jpg";
import slide2 from "./tvoy3d.jpg";
      ...
      >
        ...
        <SwiperSlide>
          <div className="slide-wrap">
            ...
            <p>yurist42.ru</p>
            <p>Сайт разработан на NEXT JS</p>
            <p>Срок разработки: 30 дней</p>
            <p>Стоимость разработки: 100 000 руб</p>
            <p>Конверсия сайта: 16%</p>
          </div>
        </SwiperSlide>
        {/* <SwiperSlide>
          <div className="slide-wrap">
            <Link href="https://iluma-store.ru">
