      ...
      >
        <SwiperSlide>
          ...
          >
            <div className="fon-img bg-[#181f24e6]">
              ...
              <p className="slide-text-p">- Одностраничные от 60 000 руб</p>
              <p className="slide-text-p">- Многостраничные от 100 000 руб</p>
              <p className="slide-text-p">- Интернет-магазины от 150 000 руб</p>
        ...
        <SwiperSlide>
          <div
            className="background-image"
            style={{
              backgroundImage: `url('./modeling/modeling.png')`,
              backgroundPositionX: "100%",
            }}
          >
            <div className="fon-img bg-[#181f24e6]">
              ...
              <p className="slide-text-p">- Качественное макетирование</p>
              <p className="slide-text-p">
                - Изготовление макетов любой сложности
              </p>
              <p className="slide-text-p">- Прототипирование макетов</p>
              <div className="buttons-car">
                <Link href="/modeling" onClick={() => window.scrollTo(0, 0)}>
                  <button className="d-btn">ПОДРОБНЕЕ</button>
                </Link>
                {/* <Link href={"javascript:void(0)"} onClick={scrollToOrder}>
                  <button className="d-btn">ОСТАВИТЬ ЗАЯВКУ</button>
