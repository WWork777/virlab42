			...
			<div className='3d-why-left flex gap-5 md:flex-row-reverse md:w-1/2'>
				<div className='grow w-1/3 sm:w-1/4  flex flex-col'>
					<div className=' md:mr-auto'>
						<img className='ml-auto' src='./3d/stars.png' alt='image' />
					</div>
					<div className='md:mr-auto'>
						<img className='ml-auto ' src='./3d/speed.png' alt='image' />
					</div>
				</div>
				<div className='grow w-2/3 sm:w-3/4 '>
					...
					<div className='md:text-right'>
						<p className=' text-[#465a65]'>
							Замеры, промышленное макетирование, подбор материалов,
							постобработка и финишная обработка макетов
						</p>
					</div>
				</div>
			</div>
