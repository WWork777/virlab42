export const metadata = {
	...
	title: 'Создание сайтов под ключ Москва Кемерово — IT-компания ВИРЛАБ',
	description:
		'Разработка сайтов любой сложности — лендинги, корпоративные сайты, интернет-магазины. ВИРЛАБ — полное сопровождение и продвижение.',
	keywords:
