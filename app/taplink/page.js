export const metadata = {
	...
	title: 'Создание Taplink-страниц и мини-сайтов под ключ Москва Кемерово — ВИРЛАБ',
	description: 'Закажите создание стильной Taplink-страницы для бизнеса в ВИРЛАБ. Адаптивный дизайн, функциональность и интеграции для Instagram и мессенджеров.',
	keywords:
	...
	openGraph: {
		...
		title: 'Создание Taplink-страниц и мини-сайтов под ключ Москва Кемерово — ВИРЛАБ',
		description:
			'Закажите создание стильной Taplink-страницы для бизнеса в ВИРЛАБ. Адаптивный дизайн, функциональность и интеграции для Instagram и мессенджеров.',
		images: {
			url: '/og/og.jpg',
			width: 1200,
			height: 630,
