export const metadata = {
  ...
  title:
    "Графический дизайн, логотипы, фирменный стиль Москва Кемерово — ВИРЛАБ",
  description:
    "Разработка логотипов, фирменного стиля, презентаций, баннеров и рекламных материалов для бизнеса. Креативная команда ВИРЛАБ.",
  keywords:
