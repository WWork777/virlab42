...
import TelegramFunnel from "@/components/home/TelegramFunnel/TelegramFunnel";

export const metadata: Metadata = {
  metadataBase: new URL("https://virlab42.ru"),
  title:
    "Создание сайтов, 3D-печать, дизайн и продвижение — IT-компания ВИРЛАБ",
  description:
    "ВИРЛАБ — профессиональная IT-компания: создаем сайты, 3D-модели, фирменный стиль, продвигаем",
  keywords:
